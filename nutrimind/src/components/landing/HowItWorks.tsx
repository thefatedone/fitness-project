...
const steps = [
  { icon: User, title: "Create Your Profile", desc: "Tell us your goals, preferences, and dietary needs. We'll calculate your personalized targets." },
  { icon: ForkKnife, title: "Log Your Meals", desc: "Snap a photo or search our database. Our AI instantly breaks down calories, protein, carbs, and fat." },
  { icon: Sparkles, title: "Track & Improve", desc: "Monitor your progress with beautiful charts. Get AI coaching to stay on course and reach your goals." },
];
    ...
    <section id="how-it-works" className="w-full py-24 md:py-32 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">Three simple steps to transform your nutrition journey.</p>
        </div>
